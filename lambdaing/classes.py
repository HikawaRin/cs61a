...
class Player:
    ...
    def draw(self):
        ...
        # BEGIN Problem 2
        self.hand = [self.deck.draw()] + self.hand
        # END Problem 2
...
class TutorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        copy = player.hand[0].copy() if len(player.hand) != 0 else None
        if copy is not None:
            player.hand += [copy]
            added = True
        # END Problem 4
...
class TACard(Card):
    ...
    def effect(self, opponent_card, player, opponent, arg=None):
        ...
        """
        # BEGIN Problem 5
        best_card = max(player.hand, key=lambda c : self.power(c)) if len(player.hand) > 0 else None
        # END Problem 5
        # You should add your implementation above this.
        if best_card:
...
class InstructorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent, arg=None):
        ...
        """
        # BEGIN Problem 6
        re_add = False if self.power(opponent_card) < opponent_card.power(self) else True
        self.attack -= 1000
        self.defense -= 1000
